...
$string['config_border_corner_help'] = 'Set the border corner radius as a pixel (px) value.';
$string['config_border_size'] = 'Border size';
$string['config_border_size_help'] = 'Set the border thickness as a pixel (px) value.';
